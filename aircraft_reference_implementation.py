...
def main():
    ...
    dulles_airport_position = aclib.Position(
        lat=38.9519444444, long=-77.4480555556)
    ...
    # Transform: clean the fetched data and derivative data to aid in the analysis
    print('cleaning and transforming aircraft data...')
    live_aircraft_data = []
